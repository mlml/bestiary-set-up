...
if __name__ == '__main__':
    r = True
    corpus_name = 'dimensions'
    corpus_conf = {'corpus_directory': r'/mnt/e/Data/Dimensions/truncated_aligned',
                   'input_format': 'mfa',
                   'speaker_enrichment_file': r'/mnt/e/Data/Cont/speaker.txt',
                   'discourse_enrichment_file': r'/mnt/e/Data/Dimensions/discourse.txt',
